...
class Controller implements MouseListener {
    ...
    boolean update() {
        ...
        GeneticAlgorithm.timer = iter;
//		System.out.println("iter: " + iter);
//		System.out.println("Timer: " + GeneticAlgorithm.timer);
    ...
    static void doBattle(IAgent blue, IAgent red) throws Exception {
        ...
        new Timer(1, c.view).start(); // creates an ActionEvent at regular intervals, which is handled by View.actionPerformed
    }

    static int doBattleNoGuiTimer(IAgent blue, IAgent red, BattleResult res) throws Exception{
        ...
        if (c.model.getFlagEnergySelf() < 0.0f && c.model.getFlagEnergyOpponent() >= 0.0f) {
            ...
            res.setBattleTimer(c.iter);
            res.setBattleResult(-1);
            return -1;
