...
public class Matrix
{
	...
	public ArrayList<double[]> getM_data() {
		return m_data;
	}

	public void setM_data(ArrayList<double[]> m_data) {
		this.m_data = m_data;
	}
	...
	public ArrayList<HashMap<String, Integer>> getM_str_to_enum() {
		return m_str_to_enum;
	}

	public void setM_str_to_enum(ArrayList<HashMap<String, Integer>> m_str_to_enum) {
		this.m_str_to_enum = m_str_to_enum;
	}

	public ArrayList<HashMap<Integer, String>> getM_enum_to_str() {
		return m_enum_to_str;
	}

	public void setM_enum_to_str(ArrayList<HashMap<Integer, String>> m_enum_to_str) {
