            ...
            if (m.getDistanceToDestination(0) != 0) {
                ...
                if(c.isLeft){
                    ...
                    if (!bestPathList.isEmpty()) {
                        ...
                        float speed = m.getTravelSpeed(newState.location.getX(), newState.location.getY());
                    ...
                    frontier = searchPath.getFrontier();
                    System.out.printf("Distance to click: %f \n", AstarSearch.getDistance(new Location(m.getX(), m.getY()),
                            destination));
                }
